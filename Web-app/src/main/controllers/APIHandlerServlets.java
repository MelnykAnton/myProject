...
import static Utils.JSONResponse.ERROR_INCORRECT_REQUEST;

public class APIHandlerServlets extends HttpServlet{
    ...
    private void process(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        try {
            ...
            apiRequestHandler = getApiRequestHandlers().get(requestType);
